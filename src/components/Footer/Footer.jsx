      ...
      <MDBContainer className="text-center text-md-left">
        <MDBRow className="text-center text-md-left mt-3 pb-3">
          ...
          <MDBCol md="2" lg="2" xl="2" className="mx-auto mt-3">
            ...
            <p>
              <a href="http://deepaksingh-portfolio.netlify.app/">Portfolio</a>
            </p>
          </MDBCol>
          ...
          <MDBCol md="4" lg="3" xl="3" className="mx-auto mt-3">
            ...
            <p>
              <i className="fa fa-envelope mr-3" /> dp2707.bbk@gmail.com
            </p>
            <p>
              <i className="fa fa-phone mr-3" /> +91 9458708025
            </p>
          </MDBCol>
        </MDBRow>
        <hr />
            ...
            <div className="text-center text-md-right">
              <ul className="list-unstyled list-inline">
                ...
                <li className="list-inline-item">
                  <a
                    className="btn-floating btn-sm rgba-white-slight mx-1"
                    href="https://www.linkedin.com/in/deepak-singh-140135136/"
                  >
